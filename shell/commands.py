...
class MkdirCommand(BaseCommand):
    ...
    def execute(self, command):
        ...
        self.system.mkdir(command.args[0])
...
class TouchCommand(BaseCommand):
    ...
    def execute(self, command):
        ...
        self.system.touch(command.args[0])
...
class CatCommand(BaseCommand):
    ...
    def execute(self, command):
        ...
        text = self.system.cat(command.args[0])
...
class WriteCommand(BaseCommand):
    ...
    def execute(self, command):
        ...
        self.system.write(filename, text)
...
class AppendCommand(BaseCommand):
    ...
    def execute(self, command):
        ...
        self.system.append(filename, text)
